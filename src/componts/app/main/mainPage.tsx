  ...
  return (
    <Box>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalContent
          maxW={fullScreen ? "100%" : "1724px"}
          maxH={fullScreen ? "100%" : "86%"}
          m={fullScreen ? "0" : "20px"}
          overflowY="auto"
          borderRadius="none"
          sx={scrollbarHideStyles}
        >
            ...
            >
              <Box w="100%" h="100%">
                ...
                <Box border="4px solid #AFAFAF" borderTop="0" p="20px">
                  ...
                  <Text fontSize="18px" color="#303C55" mb="10px">
                    Name
                  </Text>
                  <Input
                    p="10px"
          ...
          <Box w="100%" mx="auto" position="relative">
            ...
            >
              ...
              >
                <Box p={{ base: "2px", sm: "5px" }} bg="white" cursor="pointer">
                  <Image
                    minW="20px"
                    src="https://i.ibb.co/4mzQdz8/Group-91.png"
                    alt="img"
                  />
                </Box>
                <Flex
                ...
                >
                  <Text
                    ...
                    overflowX="auto"
                  >
                    https://solana-referral.vercel.app{pathname}
                  </Text>
                </Flex>
            ...
            <Box
              ...
              borderBottom={{
                base: "8px solid #D9D9D9",
                md: "16px solid #D9D9D9",
              }}
            >
                ...
                <Grid templateColumns={{ base: "auto", xl: "332px 1fr" }}>
                  ...
                  <Box px={{ base: "6px", md: "20px" }} py="20px">
                    ...
                    {pathname === "/packages-details" && (
                      <PackageDetails displayPackage={displayPackage} />
                    )}
      ...
      <Flex w="100%" h="40px" bg="#A0A0A0" position="fixed" bottom="0">
        <Flex w="100%">
          <Image
            src="https://i.ibb.co/VMhVHDw/image-53.png"
            cursor="pointer"
            onClick={isStartOpen ? onStartClose : onStartOpen}
          />
          {showCase && (
            <Flex
              h="100%"
            ...
            >
              <Image
                display="inline"
                w="30px"
                src="https://i.ibb.co/qysKfQ3/image-64-removebg-preview.png"
              />
              <Text
