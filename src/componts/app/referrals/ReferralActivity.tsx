  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Flex
            ...
            gap="12px"
            pb="20px"
            borderBottom="1px solid #8AABED80"
          >
            <Image
              ...
              h="32px"
            />
            <Text fontSize="24px">Earnings</Text>
          </Flex>
          <Flex
            w="100%"
            ...
            >
              ...
              {copySuccess ? (
                ...
                <Image
                  ...
                  h="24px"
                  onClick={() =>
                    copyToClipboard("https://solana.com/refferral/01jDf4")
                  }
                />
              )}
            </Flex>
          ...
          >
            <Flex justifyContent="space-between" mb="50px">
              <Box>
                ...
                <Text fontSize={{ base: "40px", sm: "48px" }}>$100.00</Text>
              </Box>
            </Flex>
            <Flex
              justifyContent="end"
      ...
      >
        <Flex alignItems="center" gap="12px" mb="20px">
          <Image
            ...
            h="32px"
          />
          <Text fontSize={{ base: "20px", sm: "24px" }}>My referrals</Text>
        </Flex>
        <Box>
          <TreeChart data={data} />
        </Box>
      ...
      >
        ...
        <Flex display={{ base: "block", md: "flex" }} mb="15px">
          <Box minW={{ base: "100%", md: "476px" }} w="100%">
            <Text fontSize={{ base: "14px", sm: "16px" }} mt="20px">
              Compensation Plan [Distribution plan 85% +5%]Unilever : 85% PAYOUT
              to Top Line till 10th Level
            </Text>
            <Text>
              <br /> 1 LEVEL: 10%
              <br /> 2 LEVEL: 10%
          ...
          <Box>
            <Text fontSize={{ base: "14px", sm: "16px" }} my="20px">
              Rule 80/20%
              <br />
              Means you can withdraw 80%, will be sent directly to your
              metamask.
            </Text>
            <Text fontSize={{ base: "14px", sm: "16px" }} my="20px">
              20% remaining will be sent to LP Wallet and given the user Credits
              for that amount to be swapped later for our Token
            </Text>
            <Text fontSize={{ base: "14px", sm: "16px" }} mt="20px">
        ...
        <Text fontSize={{ base: "14px", sm: "16px" }}>
          Different phases have different difficulty coefficients, which affect
          the number of credits earned per commission and the token value for
          airdrops. The coefficient increases as the number of people in the
          network grows. It’s sort of halving, the number of credit you can earn
          (by purchasing packages or commissions) decreases over time, so we
          will need an algorithm in it, that measures number of people and the
          difficulty coefficient, naturally if you join at the beginning will
          give you more credits from the package you purchase, then for example
          when there are already 10000 users, because the more people join The
          more coefficient grow.
        </Text>

        <Image
          mt="20px"
          maxW={{ base: "260px", sm: "100%" }}
          src="https://i.ibb.co/L6d6mC6/image-32.png"
          alt=""
        />
